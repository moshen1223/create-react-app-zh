...
- [支持的语言特性和Polyfills](https://github.com/XanthusL/create-react-app-zh/blob/master/packages/react-scripts/template/README-zh.md#支持的语言特性和polyfills)
- [编辑器中的语法高亮](https://github.com/XanthusL/create-react-app-zh/blob/master/packages/react-scripts/template/README-zh.md#编辑器中的语法高亮)
- [编辑器中显示lint输出](https://github.com/XanthusL/create-react-app-zh/blob/master/packages/react-scripts/template/README-zh.md#编辑器中显示lint输出)
- [在编辑器中调试](https://github.com/XanthusL/create-react-app-zh/blob/master/packages/react-scripts/template/README-zh.md#在编辑器中调试)
- [改变页面 `<title>`](https://github.com/XanthusL/create-react-app-zh/blob/master/packages/react-scripts/template/README-zh.md#改变页面title)
- [安装依赖](https://github.com/XanthusL/create-react-app-zh/blob/master/packages/react-scripts/template/README-zh.md#安装依赖)
- [导入组件](https://github.com/XanthusL/create-react-app-zh/blob/master/packages/react-scripts/template/README-zh.md#导入组件)
- [添加样式表](https://github.com/XanthusL/create-react-app-zh/blob/master/packages/react-scripts/template/README-zh.md#添加样式表)
